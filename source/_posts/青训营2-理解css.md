...
![](https://cdn.jsdelivr.net/gh/qw-null/BlogImages/20220116155641.png)
...
## css如何工作？
![](https://cdn.jsdelivr.net/gh/qw-null/BlogImages/20220116160258.png)
...
## 颜色
RGB
![](https://cdn.jsdelivr.net/gh/qw-null/BlogImages/20220116163451.png)

HSL
![](https://cdn.jsdelivr.net/gh/qw-null/BlogImages/20220116163513.png)
![](https://cdn.jsdelivr.net/gh/qw-null/BlogImages/20220116163605.png)

![](https://cdn.jsdelivr.net/gh/qw-null/BlogImages/20220116163758.png)
...
```
![](https://cdn.jsdelivr.net/gh/qw-null/BlogImages/20220116165308.png)
...
## 调试CSS
![](https://cdn.jsdelivr.net/gh/qw-null/BlogImages/20220116170138.png)
...
## 初始值
![](https://cdn.jsdelivr.net/gh/qw-null/BlogImages/20220116180930.png)

## CSS求值过程
如何从一个DOM节点生成一棵渲染树或渲染节点
![](https://cdn.jsdelivr.net/gh/qw-null/BlogImages/20220116212438.png)

## 布局
布局相关技术：常规流、浮动、绝对定位
![](https://cdn.jsdelivr.net/gh/qw-null/BlogImages/20220116213012.png)
...
#### padding
![](https://cdn.jsdelivr.net/gh/qw-null/BlogImages/20220116213507.png)
设置数值为百分数时，是相对于元素容器宽度

#### border
![](https://cdn.jsdelivr.net/gh/qw-null/BlogImages/20220116213728.png)
...
#### margin
![](https://cdn.jsdelivr.net/gh/qw-null/BlogImages/20220116214233.png)
...
#### 块级 VS 行级
![](https://cdn.jsdelivr.net/gh/qw-null/BlogImages/20220116215507.png)
![](https://cdn.jsdelivr.net/gh/qw-null/BlogImages/20220116215632.png)

#### display属性
可选值：
![](https://cdn.jsdelivr.net/gh/qw-null/BlogImages/20220116215824.png)
...
![](https://cdn.jsdelivr.net/gh/qw-null/BlogImages/20220117110631.png)
##### 行级排版上下文
![](https://cdn.jsdelivr.net/gh/qw-null/BlogImages/20220117111134.png)
##### 块级排版上下文
![](https://cdn.jsdelivr.net/gh/qw-null/BlogImages/20220117111649.png)
##### Flex Box
![](https://cdn.jsdelivr.net/gh/qw-null/BlogImages/20220117113905.png)
<hr/>
...
![](https://cdn.jsdelivr.net/gh/qw-null/BlogImages/20220117135611.png)
<hr/>
...
![](https://cdn.jsdelivr.net/gh/qw-null/BlogImages/20220117141220.png)

##### Grid 布局
![](https://cdn.jsdelivr.net/gh/qw-null/BlogImages/20220117141922.png)
Flex仅可以设置一个方向的布局，Grid是一个二维布局方式
![](https://cdn.jsdelivr.net/gh/qw-null/BlogImages/20220117142125.png)
<hr/>
划分网格：
```css
...
```
![](https://cdn.jsdelivr.net/gh/qw-null/BlogImages/20220117142329.png)
```css
grid-template-columns: 30% 30% auto;
grid-template-rows: 100px auto;
```
![](https://cdn.jsdelivr.net/gh/qw-null/BlogImages/20220117142357.png)
```css
...
```
![](https://cdn.jsdelivr.net/gh/qw-null/BlogImages/20220117142553.png)
<hr/>
grid line网格线：

![](https://cdn.jsdelivr.net/gh/qw-null/BlogImages/20220117143340.png)
grid area 网格区域：
网格区域使用网格线表示

![](https://cdn.jsdelivr.net/gh/qw-null/BlogImages/20220117143810.png)
![](https://cdn.jsdelivr.net/gh/qw-null/BlogImages/20220117143855.png)
...
+ fixed 开启元素的固定定位
+ sticky 开启元素的粘滞定位
![](https://cdn.jsdelivr.net/gh/qw-null/BlogImages/20220117144135.png)
![](https://cdn.jsdelivr.net/gh/qw-null/BlogImages/20220117144154.png)
